 ...
 */
 @Keep internal constructor(
     ...
     * @throws IllegalArgumentException if tilt is outside the range of 0 to 90 degrees inclusive.
     */
    @Keep internal constructor(target: LatLng?, zoom: Double, tilt: Double, bearing: Double, padding: DoubleArray?) : this(target, 0.0, zoom, tilt, bearing, 0.0, MapVinaConstants.DEFAULT_FOV, padding)
    ...
    class Builder {
        ...
        constructor(typedArray: TypedArray?) : super() {
            if (typedArray != null) {
                ...
                centerAltitude = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraCenterAltitude, 0.0f).toDouble()
                tilt = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraTilt, 0.0f).toDouble()
                roll = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraRoll, 0.0f).toDouble()
                fov = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraFov, 36.86989764584402f).toDouble()
    ...
    companion object {
        ...
        val CREATOR: Parcelable.Creator<CameraPosition> = object : Parcelable.Creator<CameraPosition> {
            override fun createFromParcel(parcel: Parcel): CameraPosition {
                ...
                // https://github.io/github/mapvina/mapvina-native/issues/1276
