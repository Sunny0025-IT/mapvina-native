...
# run
./build/platform/glfw/mbgl-glfw --style https://maps.mapvina.com/styles/v2/streets.json?key=public_key --benchmark
~~~
with Bazel
~~~bash
# build and run
bazel run //platform/glfw:glfw_app -- --style https://maps.mapvina.com/styles/v2/streets.json?key=public_key --benchmark
~~~
