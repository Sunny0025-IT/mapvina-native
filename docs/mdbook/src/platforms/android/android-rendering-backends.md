...
# OpenGL ES
./gradlew :MapVinaAndroidTestApp:installOpenglDebug

# Vulkan
./gradlew :MapVinaAndroidTestApp:installVulkanDebug
...
The same pattern applies to the library module (`MapVinaAndroid`):

```bash
./gradlew :MapVinaAndroid:assembleVulkanRelease
```
