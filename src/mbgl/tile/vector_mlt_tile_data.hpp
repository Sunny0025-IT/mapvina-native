...
namespace mbgl {
using MapVinaTile = mlt::MapVinaTile;

class VectorMLTTileFeature : public GeometryTileFeature {
public:
    VectorMLTTileFeature(std::shared_ptr<const MapVinaTile>,
...
private:
    std::shared_ptr<const MapVinaTile> tile;
...
public:
    VectorMLTTileLayer(std::shared_ptr<const MapVinaTile>, const mlt::Layer&);
...
private:
    const std::shared_ptr<const MapVinaTile> tile;
    const mlt::Layer& layer;
};
...
private:
    ...
    mutable std::shared_ptr<const MapVinaTile> tile;
};
