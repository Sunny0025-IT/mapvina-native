package com.mapvina.mlt.converter;
...
import com.mapvina.mlt.converter.encodings.EncodingUtils;
import com.mapvina.mlt.converter.encodings.GeometryEncoder;
import com.mapvina.mlt.converter.encodings.MltTypeMap;
import com.mapvina.mlt.converter.encodings.PropertyEncoder;
...
import com.mapvina.mlt.metadata.stream.PhysicalLevelTechnique;
...
public class MltConverter {
  ...
  public static byte[] convertMvt(
    ...
    var mapVinaTileBuffer = new byte[0];
