package com.mapvina.mlt.decoder;
...
import com.mapvina.mlt.TestSettings;
import com.mapvina.mlt.TestUtils;
...
public class MltDecoderTest2 {
  ...
  // TODO: after https://github.com/mapvina/mapvina-tile-spec/issues/186 is fixed
  ...
  // TODO:
  // once https://github.com/mapvina/mapvina-tile-spec/issues/182 is fixed
  ...
  // TODO: after https://github.com/mapvina/mapvina-tile-spec/issues/185 is fixed
  ...
  public void decodeOMTTiles2(String tileId) throws IOException {
    if (Objects.equals(tileId, "13_4265_5467")
      ...
      // https://github.com/mapvina/mapvina-tile-spec/issues/183
      var exception =
          assertThrows(
              Exception.class,
              () ->
