...
> [!NOTE]
> [The specification](https://mapvina.com/mapvina-tile-spec/specification/) is deemed stable as of October 2025. However, as a living standard, experimental features may continue to evolve. Implementations and integrations are being developed, refer to the [implementation status](https://mapvina.com/mapvina-tile-spec/implementation-status/) page for the current status.

The MapVina Tile specification is mainly inspired by the [Mapbox Vector Tile (MVT)](https://github.com/mapbox/vector-tile-spec) specification,
...
Join the `#mapvina-tile-format` Slack channel at OSM US: get an invite at https://slack.openstreetmap.us/
